      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="/balai/bwskalimantan5/news-1" class="btn btn-primary btn-sm">Baca</a>
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="/balai/bwskalimantan5/news-2" class="btn btn-primary btn-sm">Baca</a>
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="/balai/bwskalimantan5/news-3" class="btn btn-primary btn-sm">Baca</a>
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="/balai/bwskalimantan5/news-4" class="btn btn-primary btn-sm">Baca</a>
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="/balai/bwskalimantan5/news-5" class="btn btn-primary btn-sm">Baca</a>
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card">
            ...
            <div class="card-body">
              <p class="card-text">Penandatanganan Kontrak Paket Tender/Seleksi Bidang Irigasi dan Rawa.</p>
              <a href="/balai/bwskalimantan5/news-6" class="btn btn-primary btn-sm">Baca</a>
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="/balai/bwskalimantan5/news-7" class="btn btn-primary btn-sm">Baca</a>
            </div>
          </div>
        </div>
