      ...
      <ul class="navbar-nav ms-auto gap-3">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="aboutDropdown">
            ...
            <li><a class="dropdown-item" href="/kalimantan5/tusi">Tugas dan Fungsi</a></li>
          </ul>
        </li>
...
<section id="about" class="py-4 bg-light">
  <div class="container">

    <!-- Judul Tengah -->
    <h2 class="text-center text-primary fw-bold">KALIMANDAU</h2>
    <div class="row align-items-center flex-column-reverse flex-md-row">
      <!-- Kolom Teks -->
      <div class="col-md-6">
        <p class="mb-3">
          <strong>KALIMANDAU</strong> (Kalimantan Lima Andal Dalam Pelayanan Terpadu) adalah pusat layanan terpadu yang menekankan prinsip <strong>keterbukaan</strong>, <strong>efisiensi</strong>, dan <strong>akuntabilitas</strong> dalam menyediakan informasi kepada masyarakat.
        </p>
        <p class="mb-4">
        ...
        <ul class="list-group list-group-flush mb-4">
          <li class="list-group-item bg-transparent"><i class="fas fa-database text-warning me-2"></i> <strong>Membuat Permohonan:</strong> Ajukan permohonan data sumber daya air secara online.</li>
          <li class="list-group-item bg-transparent"><i class="fas fa-search-location text-warning me-2"></i> <strong>Tracking Layanan:</strong> Lacak status permohonan dan pengaduan Anda.</li>
          <li class="list-group-item bg-transparent"><i class="fas fa-poll text-warning me-2"></i> <strong>Pengaduan dan Survei:</strong> Berikan umpan balik dan bantu tingkatkan pelayanan kami.</li>
        </ul>

        <a href="https://kalimandaubwskv.id/layanan/permohonan-informasi/" class="btn btn-primary px-4 shadow-sm me-2">
      ...
      <div class="col-md-6 mb-4 mb-md-0 text-center">
        <img src="img/132338804_kalimandau-adalah.gif" alt="KALIMANDAU" class="img-fluid rounded animate__animated animate__fadeInRight">
      </div>
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="/kalimantan5/news-1" class="btn btn-primary btn-sm">Baca</a>
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="/kalimantan5/news-2" class="btn btn-primary btn-sm">Baca</a>
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="/kalimantan5/news-3" class="btn btn-primary btn-sm">Baca</a>
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="/kalimantan5/news-4" class="btn btn-primary btn-sm">Baca</a>
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="/kalimantan5/news-5" class="btn btn-primary btn-sm">Baca</a>
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card">
            ...
            <div class="card-body">
              <p class="card-text">Penandatanganan Kontrak Paket Tender/Seleksi Bidang Irigasi dan Rawa.</p>
              <a href="/kalimantan5/news-6" class="btn btn-primary btn-sm">Baca</a>
            </div>
          </div>
        </div>
        ...
        <div class="swiper-slide">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="/kalimantan5/news-7" class="btn btn-primary btn-sm">Baca</a>
            </div>
          </div>
        </div>
